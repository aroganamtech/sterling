export const industries = [
  {
    ...
    solutions: ['smoke-curtains', 'staircase-pressurization', 'smoke-extraction-systems', 'control-automation'],
  ...
  },
  {
    ...
    solutions: ['smoke-curtains', 'smoke-extraction-systems', 'smoke-ventilators', 'control-automation'],
  ...
  },
  {
    ...
    solutions: ['staircase-pressurization', 'smoke-curtains', 'smoke-extraction-systems', 'control-automation'],
    standards: ['EN 12101', 'NFPA 92', 'BS 9999', 'Local Fire Code'],
  },
  {
    slug: 'metro-rail',
    ...
    solutions: ['tunnel-ventilation', 'smoke-extraction-systems', 'control-automation', 'staircase-pressurization'],
  ...
  },
  {
    ...
    solutions: ['smoke-ventilators', 'smoke-curtains', 'smoke-extraction-systems', 'control-automation'],
  ...
  },
  {
    ...
    solutions: ['smoke-extraction-systems', 'control-automation', 'staircase-pressurization'],
  ...
  },
  {
    ...
    solutions: ['smoke-ventilators', 'industrial-ventilation', 'smoke-curtains', 'control-automation'],
  ...
  },
  {
    ...
    solutions: ['industrial-ventilation', 'smoke-ventilators', 'smoke-extraction-systems', 'control-automation'],
  ...
  },
  {
    ...
    solutions: ['industrial-ventilation', 'smoke-extraction-systems', 'control-automation'],
  ...
  },
  {
    ...
    solutions: ['smoke-ventilators', 'smoke-extraction-systems', 'smoke-curtains', 'control-automation'],
  ...
  },
  {
    ...
    solutions: ['industrial-ventilation', 'smoke-extraction-systems', 'tunnel-ventilation', 'control-automation'],
